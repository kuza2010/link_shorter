...
public class Base62 {
    ...
    /**
     * Note if seed is unique then generated base62
     * number will be unique as well under load balance make sure this value is not same.
     */
    ...
    /**
     * @param longNumber a positive number in base 62
     * @return the same number, in base 10
     */
    public static String getBase10From62(final long longNumber) {
